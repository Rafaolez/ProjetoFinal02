    ...
    public class TipoProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TipoProdutos != null ? 
                          ...
                          Problem("Entity set 'Contexto.TipoProdutos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Contexto.TipoProdutos'  is null.");
            }
            var tipoProduto = await _context.TipoProdutos.FindAsync(id);
            if (tipoProduto != null)
            {
        ...
        {
          return (_context.TipoProdutos?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
