...
namespace ProjetoFinal.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SaidaProdutoId,ProdutoId,DataSaida,QuantidadeSaida,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Fornecedor, "ClienteId", "ClienteNome", saidaProduto.Id);
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "ProdutoId", "ProdutoNome", saidaProduto.ProdutoId);
            ViewData["TipoSaidaId"] = new SelectList(_context.TipoSaida, "Id", "TipoSaidaIdDescricao", saidaProduto.TipoSaidaId);
