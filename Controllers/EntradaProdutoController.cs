...
namespace ProjetoFinal.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EntradaProdutoId,ProdutoId,QuantidadeEntrada,DataEntrada")] EntradaProduto entradaProduto)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "ProdutoId", "ProdutoNome", entradaProduto.ProdutoId);
            return View(entradaProduto);
        }
